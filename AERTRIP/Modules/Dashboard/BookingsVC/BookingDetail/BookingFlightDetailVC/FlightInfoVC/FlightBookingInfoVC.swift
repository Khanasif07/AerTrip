...
//        self.viewModel.getBookingFees()
        ...
        FirebaseEventLogs.shared.logAccountsEventsWithAccountType(with: .BookingsFlightDetailsFlightInfo, AccountType: UserInfo.loggedInUser?.userCreditType.rawValue ?? "n/a")
