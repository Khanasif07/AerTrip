...
class UpcomingBookingsVC: BaseVC {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController<BookingData> = {
        ...
        self.fetchRequest.sortDescriptors = [NSSortDescriptor(key: "dateHeader", ascending: true), NSSortDescriptor(key: "bookingProductType", ascending: true), NSSortDescriptor(key: "bookingId", ascending: true)]
