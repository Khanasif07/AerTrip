//
//  SingleJourneyCollectionViewCell.swift
//  AERTRIP
//
//  Created by Appinventiv on 11/08/20.
//  Copyright © 2020 Pramod Kumar. All rights reserved.
//

import UIKit

class SingleJourneyCollectionViewCell: UICollectionViewCell {
...
extension SingleJourneyCollectionViewCell : UICollectionViewDataSource , UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if section == 0 {
            if baggageSuperScript?.string.uppercased() == "0P" || baggageSuperScript?.string == "0" || baggageSuperScript?.string == "?"  {
                return 0
            }
            else {
                return 1
...
//        headerView.backgroundColor = UIColor(displayP3Red: ( 204.0 / 255.0), green: ( 204.0 / 255.0), blue: ( 204 / 255.0), alpha: 1.0)
    ...
    if section == 0 {
        ...
        if smartIconsArray?.count == 0  || baggageSuperScript?.string.uppercased() == "0P" || baggageSuperScript?.string == "0" || baggageSuperScript?.string == "?"  {
            return .zero
        }
