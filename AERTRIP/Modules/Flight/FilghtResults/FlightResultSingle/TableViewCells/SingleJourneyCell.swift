...
extension SingleJourneyCell : UICollectionViewDataSource , UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if section == 0 {
            if baggageSuperScript?.string.lowercased() == "0p" || baggageSuperScript?.string == "0" || baggageSuperScript?.string == "?" {
                return 0
            } else {
                return 1
            }
...
//        headerView.backgroundColor = UIColor(displayP3Red: ( 204.0 / 255.0), green: ( 204.0 / 255.0), blue: ( 204 / 255.0), alpha: 1.0)
    ...
    if section == 0 {
        ...
        if smartIconsArray?.count == 0  || baggageSuperScript?.string.lowercased() == "0p" || baggageSuperScript?.string == "0" || baggageSuperScript?.string == "?" {
            return .zero
        }
