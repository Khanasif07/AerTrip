...
import UIKit
let errorColorTextField = UIColor(red: 255/255.0, green: 55/255.0, blue: 55/255.0, alpha: 1)
let primaryColorTextField = UIColor(red: 0/255.0, green: 204/255.0, blue: 153/255.0, alpha: 1)
let grayColorTextField = UIColor(red: 153/255.0, green: 153/255.0, blue: 153/255.0, alpha: 1)
...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @IBInspectable dynamic open var titleColor: UIColor = grayColorTextField {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var errorColor: UIColor =  errorColorTextField{
        didSet {
            updateColors()
        }
    }
    ...
    @IBInspectable dynamic open var disabledColor: UIColor = grayColorTextField {
        didSet {
            updateControl()
            updatePlaceholder()
        }
    ...
    @IBInspectable dynamic open var selectedTitleColor: UIColor = primaryColorTextField {
        didSet {
            updateTitleColor()
        }
    }
    ...
    */
    ...
    @IBInspectable open var hasErrorMessage: Bool {
