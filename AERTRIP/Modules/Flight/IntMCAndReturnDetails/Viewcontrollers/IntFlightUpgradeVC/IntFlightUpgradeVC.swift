...
class IntFlightUpgradeVC: BaseVC, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate
{
    //MARK:- Outlets
...
//        setupSwipeDownGuesture()
    ...
    func setupFarebreakupView(){
        ...
        fareBreakupVC.view.frame.origin.y = (UIScreen.height - fareBreakupVC.view.frame.height)
        self.view.addSubview(fareBreakupVC.view)
        self.addChild(fareBreakupVC)
        fareBreakupVC.didMove(toParent: self)
        self.view.bringSubviewToFront(self.fareBreakupVC.view)
    }
    ...
    func setupDisplayView(){
        ...
        case 568: //iPhone SE | 5S
            var viewHeight = 0
                ...
                if fewSeatsLeftViewHeight == 40{
                    self.planCollectionViewBottom.constant = self.fareBreakupVC.view.height//15
        ...
        case 736: //iPhone 6 Plus | 8 plus | 6s plus | 7 Plus
                ...
                if fewSeatsLeftViewHeight == 40{
                    self.planCollectionViewBottom.constant = 20
                    screenHeight = Int(screenSize.height - 150 +  self.journeyNameDisplayViewHeight.constant)
                }else{
...
//                                                print("calculatedAmount= ", calculatedAmount)
    ...
    {
        self.bookButtonTapped(journeyCombo: [])
...
extension IntFlightUpgradeVC : FareBreakupVCDelegate{
