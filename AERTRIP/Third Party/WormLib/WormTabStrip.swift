...
public struct WormTabStripStylePropertyies {
    ...
    var kPaddingOfIndicator:CGFloat = 0
    ...
    var spacingBetweenTabs:CGFloat = 0
    ...
    var tabItemDefaultFont:UIFont = AppFonts.Regular.withSize(17.0)
    var tabItemSelectedFont:UIFont = AppFonts.Regular.withSize(17.0)
...
public class Ocl: UIView,UIScrollViewDelegate {
    ...
    private func addContentScrollView(){
        if eyStyle.isHideTopScrollView {
            ...
            contentScrollView.frame = CGRect(x:0,y: eyStyle.kHeightOfTopScrollView+eyStyle.kHeightOfDivider,width:Width, height:Height-eyStyle.kHeightOfTopScrollView-eyStyle.kHeightOfDivider + 56 - 20 - UIDevice.bottomSafeArea) // Added this for personal height adjsut
        }
        ...
        contentScrollView.autoresizingMask = [.flexibleHeight]
    ...
    ***************************************/
    ...
    private func selectTab(tab:WormTabStripButton){
        ...
        delegate?.WTSSelectedTabIndex(index: currentTabIndex)
    ...
    private func slideWormToTabPosition(tab:WormTabStripButton){
        self.worm.frame.origin.x = tab.frame.origin.x + 9.0
        self.worm.frame.size.width = tab.frame.width - 18.0
    }
    /*********************
