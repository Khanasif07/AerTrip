...
public final class PKViewPagerTabView: UIView {
     ...
     */
    internal func setup(tab:PKViewPagerTab, options:PKViewPagerOptions , condition:SetupCondition) {
        
        switch options.tabType {
            
        case PKViewPagerTabType.basic:
            setupBasicTab(condition: condition, options: options, tab: tab)
            
        case PKViewPagerTabType.image:
            setupImageTab(condition: condition, withText: false,options: options, tab:tab)
            
        case PKViewPagerTabType.imageWithText:
     ...
     */
    fileprivate func setupBasicTab(condition:SetupCondition, options:PKViewPagerOptions, tab:PKViewPagerTab) {
     ...
     */
    fileprivate func setupImageTab(condition:SetupCondition, withText:Bool, options:PKViewPagerOptions, tab:PKViewPagerTab) {
    ...
    fileprivate func buildTitleLabel(withOptions options:PKViewPagerOptions, text:String) {
    ...
    fileprivate func buildImageView(withOptions options:PKViewPagerOptions, image:UIImage?) {
     ...
     */
    internal func updateFrame(atIndex index:Int, withWidth width:CGFloat, options:PKViewPagerOptions) {
