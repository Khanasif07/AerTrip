...
enum AppColors {
    ...
    /// RGB - 255, 51, 51,   (254, 68, 56)
    static let themeRed254 = UIColor(named: "themeRed254") ?? .white
    ...
    static let hotel51  = UIColor(named: "hotel51") ?? UIColor(displayP3Red: 0.5921568627, green: 0.5921568627, blue: 0.5921568627, alpha: 1)
   ...
   // (0, 0, 0) (153, 153, 153)
    ...
    //(255, 255, 255, 1.0) (49, 49, 49, 1)
    static let selectDestinationHotelHeaderColor = UIColor(named: "selectDestinationHotelHeaderColor") ?? UIColor(displayP3Red: 1, green: 1, blue: 1, alpha: 0)
...
//    (255, 255, 255, 0) (26, 26, 26)
    ...
    /// RGB - 255, 255, 255   Dark RGB  82, 82, 82
    static let white82  = UIColor(named: "white82") ?? AppColors.themeWhite
...
//    (0, 0, 0, 0.2) (0, 0, 0)
    static let black20Percent = UIColor(named: "black20Percent") ?? AppColors.themeWhite
