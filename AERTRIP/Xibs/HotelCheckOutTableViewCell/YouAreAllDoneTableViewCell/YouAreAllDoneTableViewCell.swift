...
class YouAreAllDoneTableViewCell: UITableViewCell {
    ...
    internal func configCell(forBookingId: String, forCid: String) {
        if !forBookingId.isEmpty {
            ...
            self.bookingIdAndDetailsLabel.attributedText = self.attributeLabelSetUp(prefixText: LocalizedString.YourBookingIDIs.localized, id: forCid , postfixText: LocalizedString.AndAllDetailsWillBeSentToYourEmail.localized)
