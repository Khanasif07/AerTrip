...
class SectionFooter: UICollectionReusableView {
    ...
    func doInitialSetup() {
        ...
        self.showHotelBeyondButton.addCardShadow(withColor: AppColors.themeBlack.withAlphaComponent(0.2))
        self.firstView.addCardShadow(withColor: AppColors.themeBlack.withAlphaComponent(0.5))
        self.secondView.addCardShadow(withColor: AppColors.themeBlack.withAlphaComponent(0.2))
    }
