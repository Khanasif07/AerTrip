...
class SenderChatCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        let bubbleImage = AppImages.Green_Chat_bubble.resizableImage(withCapInsets: UIEdgeInsets(top: 17, left: 25, bottom: 17, right: 25), resizingMode: .stretch).withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
