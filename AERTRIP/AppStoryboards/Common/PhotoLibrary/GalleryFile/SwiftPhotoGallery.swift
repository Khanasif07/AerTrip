...
protocol SwiftPhotoGalleryDataSource: NSObjectProtocol {
...
public class SwiftPhotoGallery: UIViewController {
    ...
    weak var dataSource: SwiftPhotoGalleryDataSource?
    weak var delegate: SwiftPhotoGalleryDelegate?
    ...
    init(delegate: SwiftPhotoGalleryDelegate, dataSource: SwiftPhotoGalleryDataSource) {
...
//    }
    ...
    private func setupPageControl() {
                ...
                pageControl = ISPageControl(frame: CGRect(x: 0, y: 0, width: 200, height: 20), numberOfPages: numberOfImages)
...
//        pageControl.pageIndicatorTintColor = pageIndicatorTintColor
        ...
        pageControlHeightConstraint = NSLayoutConstraint(item: pageControl as Any,
                                                         ...
                                                         multiplier: 1.0,
                                                         constant: 20)
        view.addConstraints([pageControlCenterXConstraint!, pageControlBottomConstraint!, pageControlWidthConstraint!, pageControlHeightConstraint!])
    }
    ...
    fileprivate func getImage(currentPage: Int) -> ATGalleryImage {
