...
public struct WormTabStripStylePropertyies {
    ...
    var tabItemDefaultFont:UIFont = AppFonts.Bold.withSize(17.0)
    var tabItemSelectedFont:UIFont = AppFonts.Bold.withSize(17.0)
...
public class WormTabStrip: UIView,UIScrollViewDelegate {
    ...
    private func addContentScrollView(){
        if eyStyle.isHideTopScrollView {
            ...
            let yValue = eyStyle.kHeightOfTopScrollView+eyStyle.kHeightOfDivider
            let height = Height-eyStyle.kHeightOfTopScrollView-eyStyle.kHeightOfDivider + 56 - 20
            contentScrollView.frame = CGRect(x:0,y: yValue ,width:Width, height: height - (window?.safeAreaInsets.bottom ?? 0.0)) // Added this for personal height adjsut
        }
